# -*- coding: utf-8 -*-
# Generated by Django 1.11.23 on 2019-08-11 15:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignments', models.ManyToManyField(to='interactWBL.Assignment')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('progress', models.CharField(choices=[(1, 'none'), (2, 'basic'), (3, 'good'), (4, 'excellent')], max_length=16)),
            ],
        ),
        migrations.CreateModel(
            name='Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('progress', models.CharField(choices=[(1, 'none'), (2, 'basic'), (3, 'good'), (4, 'excellent')], default=1, max_length=16)),
                ('competency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='interactWBL.Competency')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='interactWBL.Course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[(1, 'Quick Reflection'), (2, 'Weekly Reflection')], max_length=32)),
                ('date', models.DateField(auto_now_add=True)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='interactWBL.Course')),
            ],
        ),
        ...
        migrations.AddField(
            model_name='competencyendorsement',
            name='competency',
            field=models.ManyToManyField(to='interactWBL.PersonalCompetency'),
        ),
        migrations.AddField(
            model_name='competency',
            name='reflections',
            field=models.ManyToManyField(to='interactWBL.Reflection'),
        ),
        migrations.AddField(
            model_name='assignment',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='interactWBL.Course'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AddField(
            model_name='course',
            name='teacher',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='interactWBL.Academic'),
        ),
    ]
